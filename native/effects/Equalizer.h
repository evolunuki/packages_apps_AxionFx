...
class Equalizer {
public:
    static constexpr int NUM_BANDS = 39;
    static constexpr int LEGACY_NUM_BANDS = 10;
    static constexpr float CENTER_FREQS[NUM_BANDS] = {
        20.0f, 26.0f, 31.5f, 40.0f, 45.0f, 50.0f, 63.0f, 78.0f, 100.0f, 125.0f,
        136.0f, 160.0f, 200.0f, 235.0f, 250.0f, 315.0f, 406.0f, 500.0f, 630.0f, 703.0f,
        800.0f, 1000.0f, 1216.0f, 1600.0f, 2000.0f, 2104.0f, 2500.0f, 3150.0f, 3640.0f, 4000.0f,
        5000.0f, 6299.0f, 8000.0f, 10000.0f, 10897.0f, 12500.0f, 16000.0f, 18851.0f, 20000.0f
    };
